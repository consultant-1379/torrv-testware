...
public class ApacheLoginLogoutTest extends TorTestCaseHelper implements
        TestCase {

    @Inject
    private OperatorRegistry<ApacheOperator> apacheProvider;
    private final Logger logger = org.slf4j.LoggerFactory
            .getLogger(ApacheLoginLogoutTest.class);
    ...
    public void loginParamDriven(final String userUid, final String testId,
        ...
        final ApacheOperator apacheOperator = apacheProvider
                .provide(ApacheOperator.class);
    ...
    public void logoutParamDriven(final String userUid, final String testId,
        ...
        if (!response.isSuccess()) {
            logger.warn(
                    "Failed to log out with user '{}'. Status code '{}'. Message: '{}s'",
