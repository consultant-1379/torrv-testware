...
public class WaitForFileCollectionToComplete extends TorTestCaseHelper
        implements TestCase {
    private final Logger logger = LoggerFactory
            .getLogger(WaitForFileCollectionToComplete.class);
    ...
    @Test
    public void waitForFileCollectionToComplete(
            @Input("ropInterval") final int ropInterval) {
        logger.debug("Waiting for file collection to complete.");
        ...
        final PmicResponse filesCollectedResponse = pmicCliOperator
                .waitForFileCollection(ropInterval);
