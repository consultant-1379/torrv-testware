...
public class ApacheUiLoginLogoutAsAdmin extends TorTestCaseHelper implements
        TestCase {
    ...
    private final Logger logger = org.slf4j.LoggerFactory
            .getLogger(ApacheUiLoginLogoutAsAdmin.class);
    ...
    public void loginParamDriven(final String userUid, final String testId,
        ...
        final String userId = ADMIN_USERNAME;
        final String password = ADMIN_PASSWORD;
